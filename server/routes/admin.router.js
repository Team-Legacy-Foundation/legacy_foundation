...
router.get('/adminlist', allowAdminOnly, (req, res) => {
...
router.get('/calc', allowAdminOnly, (req, res) => {
...
router.get('/pending', allowAdminOnly, (req, res) => {
...
router.get('/confirm', allowAdminOnly, (req, res) => {
...
router.get('/history', allowAdminOnly, (req, res) => {
...
router.get ('/chargehistory', allowAdminOnly, (req, res) => {
