...
AS $BODY$INSERT INTO "open_transaction"(	
	...
	hw_rm_attended,  strikes, inactive, comments,
	...
	clean_attend, detent_hours, act_or_job, passed_ua, current_service_hours,
 	hw_rm_attended, strikes, inactive, comments,
	CASE 
	WHEN (pass_class = 'yes' and entry.gpa >= 2 and detent_hours = 'no' and act_or_job = 'yes' and passed_ua = 'yes' and current_service_hours >= 2 and hw_rm_attended = 'yes' and strikes = 0) 
...
AS $BODY$INSERT INTO history(
	...
	passed_ua, current_service_hours, hw_rm_attended, strikes, inactive, 
	...
	current_service_hours, hw_rm_attended, strikes, inactive, comments,
